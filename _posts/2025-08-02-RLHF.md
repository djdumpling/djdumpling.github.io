...
1. **KL**: $\text{base}_\text{logprobs} - \text{ref}_\text{logprobs} = \ln\left(\frac{\text{probs}}{\text{ref probs}}\right) = -\ln\left(\frac{\text{ref probs}}{\text{probs}}\right)$ which accounts for the missing negative in the calculation.
