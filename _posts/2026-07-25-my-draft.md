...
This blog would not be possible without the support of many people. [Johannes Hagemann](https://x.com/johannes_hage?lang=en), [Sebastian Müller](https://x.com/omouamoua), and [Christian Reetz](https://x.com/creet_z), and [Peyton Walters](https://x.com/peywalt) for their gracious support for compute and API usage. [TODO: expand]
