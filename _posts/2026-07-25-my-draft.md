...
- **payoffs need not sum to zero.** Interests can be partly aligned rather than strictly opposed, so multiple equilibria exist and self-play can settle into private conventions that fail against a new partner.
- **three players allow kingmaking.** A losing player can decide which leader wins, and when that action barely changes its own reward, a policy-gradient update receives almost no signal for which rival benefits. "Improvement" therefore has to name an opponent distribution rather than a single optimal policy.
...
- **bids are simultaneous.** Choosing a bid requires a distribution over clearing prices, so a raw estiamte of the auction is insufficient.
...
<summary>Match schedule, Plackett-Luce fitting, and confidence intervals</summary>
...
<summary><strong>teacher screening</strong></summary>

<span id="teacher-screening"></span>
...
<summary><strong>dataset construction</strong></summary>
...
<summary><strong>checkpoint selection panel</strong></summary>

<span id="checkpoint-selection"></span>
...
<summary><strong>reward construction</strong></summary>

<span id="reward-construction"></span>
...
<summary><strong>chosen-action calibration check</strong></summary>

<span id="win-probability-calibration"></span>
...
<summary><strong>defining decision regret</strong></summary>

<span id="decision-regret"></span>
...
<summary><strong>expert iteration (ExIt)</strong></summary>
...
<summary><strong>three row types</strong></summary>

<span id="export-row-types"></span>
...
<summary><strong>deviation example</strong></summary>

<span id="deviation-example"></span>
...
<summary><strong>EV closure</strong></summary>

<span id="ev-closure"></span>
...
<summary><strong>ExIt Round 2?</strong></summary>

<span id="another-round-estimate"></span>
