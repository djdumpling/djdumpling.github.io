...
- [understanding MegaGem](#understanding-megagem)
  ...
  - [examples](#examples)
    - [Decision 1: a private hand changes expected value](#decision-1)
    - [Decision 2: missions create discontinuous value](#decision-2)
    - [Decision 3: tiebreak positioning](#decision-3)
    - [Decision 4: reveals move markets](#decision-4)
    - [Decision 5: loans and liquidity vs face value](#decision-5)
    - [Decision 6: late-game bidding](#decision-6)
...
Validation loss improves at every measured checkpoint through step 1,000, so despite the growing train–validation gap, the loss curve shows no sign of overfitting over the evaluated range.
