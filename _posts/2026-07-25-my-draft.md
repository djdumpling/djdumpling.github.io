...
Based on the gameplay panel, we select step 1,200. The self-play mean is only a sanity check, since all three copies co-evolve, but it does show that the model hasn't degenerated.
