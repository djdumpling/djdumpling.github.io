...
# post-training Qwen3-4B for Megagem
...
![A 13-model Plackett-Luce leaderboard with the distilled 4B first, unresolved against Gemini 3.1 Pro and ahead of Gemini 3 Flash in the focused comparison.](../public/public/megagemactual_blog/06_frontier_leaderboard.svg)
...
Each case asks what the current lot is worth and what spending now removes later.
...
| SFT step 1,200 | <strong style="color:#198754">64.7%</strong> | <strong style="color:#198754">50.0%</strong> | 100% | 0% | 61.63 |
...
| long DAPO | +16.48 [14.26, 18.93] | not measured | <strong style="color:#dc3545">fail: max KL 0.646</strong> |
...
![Seven GRPO runs show active token entropy and mixed gains against a scripted heuristic. Only two mainline runs directly track the frozen SFT policy, and neither anchor trends upward; a later weak-KL ablation is also flat.](../public/public/megagemactual_blog/03_selfplay_diagnosis.svg)
...
| 32 | <strong style="color:#198754">99.77%</strong> | <strong style="color:#198754">0.0105</strong> | <strong style="color:#198754">0.0370</strong> | 71.1% |
| 64 | 100% | 0 | 0 | 100% |
...
|---|---:|---:|---:|
| centralized context | <strong style="color:#198754">74.8–75.9%</strong> | 33.4–35.9% | +0.0268 to +0.0315 |
...
|---|---:|---:|---:|---:|
| non-leaky linear-bid baseline | — | <strong style="color:#198754">40.0%</strong> | — | — |
| 1 epoch, seed 0 | 62.9% | 24.0% | <strong style="color:#198754">0.0989</strong> | −2.31 |
| 1 epoch, seed 1 | 59.5% | 25.3% | 0.1096 | −107.54 |
| 1 epoch, seed 2 | 64.8% | <strong style="color:#198754">34.7%</strong> | 0.1051 | −17.64 |
| 3 epochs, seed 0 | <strong style="color:#198754">66.2%</strong> | 25.3% | 0.1011 | −16.56 |
...
| fitted mean + residual distribution | <strong style="color:#198754">2.819</strong> | <strong style="color:#198754">+1.304</strong> |
...
![Across an 18-arm, 200-seed dynamics sweep, paired margin rises and then falls with the liquidity premium. The archived live setting lies near the failed myopic selector’s 4.27 deviations per game; lambda values at least one are muted as proxy artifacts, and the simulator fails absolute calibration.](../public/public/megagemactual_blog/07_dynamics_sweep.svg)
...
![Five separate paired experiments show the negative myopic selector, the paced repair, transfer to an SFT-fitted price law, and retention in style-matched distilled weights.](../public/public/megagemactual_blog/05_liquidity_and_distillation.svg)
...
|---|---:|:---:|---:|---|
| Distilled vs Gemini 3 Flash | <strong style="color:#198754">0.56</strong> | <strong style="color:#198754">[0.52, 0.60]</strong> | +5.2 | Distilled win |
| Distilled vs Gemini 3.1 Pro | 0.53 | [0.48, 0.57] | +0.8 | unresolved |
| Gemini 3.1 Pro vs Gemini 3 Flash | <strong style="color:#198754">0.59</strong> | <strong style="color:#198754">[0.54, 0.65]</strong> | +4.4 | Pro win |
