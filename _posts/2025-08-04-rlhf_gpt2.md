...
summary: "We implement RLHF with PPO from scratch to fine-tune GPT-2 models for sentiment classification. The next blog post will focus more on interpretability, i.e. interpreting the logits, residual stream, and attention heads."
---

# Whirlwind of PPO, RLHF and Interp from scratch (Part 1 — in progress)

**Summary**: we implement RLHF with PPO from scratch to fine-tune GPT-2 models for sentiment classification. The next blog post will focus more on interpretability, i.e. interpreting the logits, residual stream, and attention heads. View the full implementation [here](https://github.com/djdumpling/rl/tree/main/rlhf_transformer).
