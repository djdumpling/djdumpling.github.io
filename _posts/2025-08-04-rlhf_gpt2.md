...
The responses from the decreased but scaled temperature run was as expected but non-interesting; shorter sentences with a less rich vocabulary. For the final additional implementation, we proceed based off of the `gpt2_neg_adaptiveKL` model.

Dense rewards coming soon... :)