---
title: "whirlwind of PPO and RLHF for LLMs from scratch"
date: 2025-08-04
tags: [Other]
---
...
### PPO
![PPO Algorithm Diagram](/IMG_0111.jpg)
...
![rlhf_framework](/rlhf_framework.jpg)
...
<table>
  <tr>
    <th style={{backgroundColor: "#d1ecf1"}}>Tokens</th>
    <th style={{backgroundColor: "#d1ecf1"}}>Samples</th>
  </tr>
  <tr>
...
![gpt2_medium_GAE_1](/gpt2_medium_GAE_1.png)

![gpt2_medium_GAE_1](/gpt2_medium_GAE_2.png)
...
<table>
  <tr>
    <th style={{backgroundColor: "#d4edda"}}>Reward</th>
    <th style={{backgroundColor: "#d4edda"}}>Ref logprobs</th>
    <th style={{backgroundColor: "#d4edda"}}>Sample (green model)</th>
  </tr>
  <tr>
    <td>0.0143</td>
    <td>-258.19</td>
...
<table>
  <tr>
    <th style={{backgroundColor: "#f8d7da"}}>Reward</th>
    <th style={{backgroundColor: "#f8d7da"}}>Ref logprobs</th>
    <th style={{backgroundColor: "#f8d7da"}}>Sample (red model)</th>
  </tr>
  <tr>
    <td>0.9526</td>
    <td>-112.02</td>
...
![testbed_1](/gpt2_testbed_1.png)
![testbed_1](/gpt2_testbed_2.png)
...
![gpt2_neg_init](/gpt2_neg_init.png)
...
![gpt2_neg_prefix](/gpt2_neg_prefix.png)
...
![gpt2_neg_temp_clip](/gpt2_neg_temp_clip.png)
...
![gpt2_neg_temp_clip](/gpt2_neg_kl_ent.png)
...
![pt2_neg_maxgradnorm](/gpt2_neg_maxgradnorm.png)
...
![gpt2_valuehead](/gpt2_valuehead.png)
...
![gpt2_neg_whiten](/gpt2_neg_whiten.png)
...
![gpt2_neg_logit_adaptive](/gpt2_neg_logit_adaptive.png)
