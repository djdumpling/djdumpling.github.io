...
![Methodology flowchart](/sea_privacy/design.png)
...
<img src="/sea_privacy/privacy_utility_apneap.png" alt="Privacy-Utility Trade-off for Activation Patching" style={{width: "60%", display: "block", margin: "0 auto"}} />
...
<img src="/sea_privacy/privacy_utility_random.png" alt="Privacy-Utility Trade-off for Random Noise Steering" style={{width: "60%", display: "block", margin: "0 auto"}} />
...
<img src="/sea_privacy/privacy_utility_sea.png" alt="Privacy-Utility Trade-off for SEA" style={{width: "60%", display: "block", margin: "0 auto"}} />
...
![Privacy-Utility Trade-off by Text Threshold (GPT-Neo-1.3B)](/sea_privacy/threshold_comparison.png)
